...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2017 at 03:29 PM
...
INSERT INTO `arduino` (`arduinoID`, `appID`, `piID`, `arduinoDescription`, `status`) VALUES
('AD001', 'AP001', 'RP001', 'This arduino is Uno with 14 digital input/output pins, 6 analog inputs, a 16 MHz quartz crystal, a USB connection, a power jack, an ICSP header and a reset button', 'reachable'),
('AD002', 'AP002', 'RP002', 'This arduino is YUN with 18 digital input/output pins, 8 analog inputs, a 16 MHz quartz crystal, a USB connection, a power jack, an ICSP header and a reset button', 'Unreachable');
...
ALTER TABLE `arduino`
  ...
  ADD CONSTRAINT `fk_arduino_pi` FOREIGN KEY (`piID`) REFERENCES `raspberrypi` (`piID`);
